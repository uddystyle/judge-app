	...
	const faqCategories = [
		{
			...
			faqs: [
				...
				},
				{
					...
					answer:
						'無料プランは組織メンバー1名、検定員3名まで、月間3セッションまで利用できます。有料プランでは、より多くのメンバー・検定員を追加でき、研修モードなどの機能が利用できます。大会モードはプランに含まれず、1大会ごとのスポット販売（お見積り）です。詳しくは料金プランページをご覧ください。'
				},
				{
					question: '大会モードを利用するには？',
					answer:
						'大会モードは月額プランに含まれず、1大会ごとのスポット販売です。お問い合わせフォームから大会の規模（参加人数・検定員数・開催日）をお知らせいただくと、個別にお見積りいたします。ご利用確定後に組織へ大会チケットを付与し、セッション作成時に1枚消費されます。大会データの保存期間は組織のプランに準拠するため、大会終了後は結果のExcelエクスポートをおすすめします。'
				},
				{
		...
		},
		{
			...
			faqs: [
				...
				},
				{
					...
					answer:
						'大会モードのセッションでは、スコアボードのURLを共有すると、URLを知っている人が結果をリアルタイムで閲覧できます。競技者や観客がスマートフォンで結果を確認できます。（スコアボード公開は大会モードの機能です）'
				}
			]
		},
		{
		...
		},
		{
			...
			faqs: [
				...
				},
				{
					...
					answer:
						'はい、年間プランは2ヶ月分お得になります（年額＝月額10ヶ月分）。例えば、Basicプランの場合、月額¥8,800×12ヶ月=¥105,600のところ、年額¥88,000で¥17,600お得です。'
				},
				{
